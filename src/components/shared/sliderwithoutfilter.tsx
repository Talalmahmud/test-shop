...
const ProductSliderWithoutFilter = ({ slides, className }: Props) => {
  ...
  }, [swiperInstance]); // Added filteredSlides dependency
...
export default ProductSliderWithoutFilter;
