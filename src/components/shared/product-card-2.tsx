...
export default function ProductCard2({
  ...
  return (
    <div className={`group relative pb-2 transition duration-300 ${className}`}>
      {/* Discount Badge */}
      ...
      <Link href={`/product/${item.slug}`}>
        <CardContent className="flex flex-col w-full p-0">
          {/* Image Wrapper */}
          <div className="group relative h-[300px] md:h-[400px] w-full overflow-hidden bg-gray-50">
            <Image
          ...
          <div className=" w-full">
            ...
            <h3 className="text-[16px] font-sans font-bold text-left line-clamp-2 truncate h-12 overflow-hidden">
              {item.name}
            </h3>
            {/* Sales count */}
